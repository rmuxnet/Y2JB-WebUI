...
You just have to select (or drag and drop) a payload then click on the "upload a payload" button, you can also directly copy you'r payloads inside the payloads folder, you can find some payloads aleardy in the folder for you to test.
